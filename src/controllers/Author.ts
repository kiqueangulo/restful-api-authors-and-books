...
const createAuthor = (req: Request, res: Response) => {
    ...
    const author = new Author({ _id: new mongoose.Types.ObjectId(), name: name });
...
const readAllAuthors = (req: Request, res: Response) => {
    return Author.find()
...
export default { createAuthor, readAuthor, readAllAuthors, updateAuthor, deleteAuthor };
